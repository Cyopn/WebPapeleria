        ...
        <footer className='bg-gray-800 text-white py-3 mt-10'>
            <div className='flex flex-col justify-left px-10 py-2 gap-2'>
                ...
                <div className='flex w-full justify-evenly text-sm'>
                    ...
                    <Link href='/services/bound/' className='hover:text-yellow-300 transition'>Encuadernado e Impresion</Link>
                    <Link href='/services/spiral/' className='hover:text-yellow-300 transition'>Anillado e Impresion</Link>
                    <Link href='/services/docs/' className='hover:text-yellow-300 transition'>Documentos Especiales</Link>
                    <Link href='/services/photo/' className='hover:text-yellow-300 transition'>Impresion de Fotografia</Link>
                </div>
            ...
            <div className='container mx-auto text-center text-md'>
                <p>Office TESChi - Centro de Cooperacion Ademica Industrial CCAI</p>
