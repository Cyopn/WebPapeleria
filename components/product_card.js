...
export default function ProductCard({ id, name, description, price, image }) {
    ...
    return (
        <div className='w-[90%] flex justify-center items-center p-4'>
            ...
            {open && (
                <div onClick={handleClose} className={`fixed inset-0 z-[60] flex items-center justify-center bg-black/50 transition-opacity duration-200 ${visible ? 'opacity-100' : 'opacity-0'}`}>
